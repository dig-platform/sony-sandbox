...
import {registerForm, registerFormGroup, setForm} from './store/ngrx-form.actions';
...
export class NgrxFormComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  @ContentChildren(NgrxFormStepDirective, { read: TemplateRef }) formTemplates!: QueryList<NgrxFormDirective>;

  // optional group id, only required for form groups
  @Input() group!: string;

  // instanceId of the form to display
